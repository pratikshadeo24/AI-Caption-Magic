...
def resize_image(image_path, output_size):  # Resize to 500x500 pixels, or any size you prefer
    image = Image.open(image_path)
    resized_image = image.resize(output_size)
    resized_image.save(image_path)  # Save the resized image at the same path
...
def upload_image():
    ...
    if file:
        ...
        resize_image(filepath, output_size=(100, 100))
